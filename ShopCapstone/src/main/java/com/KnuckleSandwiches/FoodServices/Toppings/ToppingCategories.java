...
public class ToppingCategories {
    ...
    public static final Map<String, List<String>> regularToppings = Map.of(
            "Vegetables", List.of("lettuce", "tomato", "kale", "red onion", "cucumber", "pickles", "italian white truffle", "pickled jalapenos", "pickled banana peppers", "spinach", "arugula", "micro greens", "pickled carrot and daikon", "roasted bell peppers"),
